...
"""
Test script for the Export/Import tools.
This replaces the langgraph-based test implementation.
"""
...
logger = logging.getLogger("test_export_import_tools")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test the Export/Import tools")
